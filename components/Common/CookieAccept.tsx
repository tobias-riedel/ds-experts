...
const CookieAccept = () => {
  return (
    ...
    >
      ...
      Sie können Ihre Einstellungen jederzeit ändern, indem Sie in der Fußzeile jeder Seite auf Cookie-Einstellungen
      klicken. Weitere Informationen zu den Cookies finden Sie in unseren{' '}
